...
// optimize populateBasketList() function, create an index of products
// to only search through id not the full array
const productsBasketIndex = products.reduce((index, product) => {
...
function populateBasketList() {
  ...
  if (basket.length === 0) {
    ...
    basket.forEach((basketItem) => {
      ...
      const product = productsBasketIndex[basketItem.productId];
